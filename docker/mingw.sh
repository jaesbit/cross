...
main() {
    ...
    apt-get install --assume-yes g++-mingw-w64-i686 gcc-mingw-w64-i686 gcc-mingw-w64-x86-64 g++-mingw-w64-x86-64
}
...
#    ln -fs /usr/bin/autoconf /usr/bin/autoconf2.69
#    ln -fs /usr/bin/autom4te /usr/bin/autom4te2.69
#
